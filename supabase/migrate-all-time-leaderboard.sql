-- ============================================================
-- SQL Migration to add All-Time Top Chatters Leaderboard RPC
-- Run this in your Supabase SQL Editor
-- ============================================================

CREATE OR REPLACE FUNCTION vip_livestream.get_all_time_top_chatters(p_limit integer DEFAULT 20)
RETURNS TABLE (
  member_id uuid,
  display_name text,
  name text,
...
GRANT EXECUTE ON FUNCTION vip_livestream.get_all_time_top_chatters(integer) TO anon, authenticated, service_role;
