...
export const MAIN_PROGRAM: SetlistRow[] = [
  {
    num: '1',
...
export const ENCORES: SetlistRow[] = [
  {
    num: 'E1',
...
export const MAIN_MUSIC_TOTAL_MIN = 58
...
export const TIMING = {
  ...
  columns: ['Component', 'Low (min)', 'High (min)', 'Notes'] as const,
  rows: [
    {
